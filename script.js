...
//WATER REMAINDER
// Schedule reminder based on plant type (e.g., tomatoes need watering every 2 days)
function setWateringReminder(plant) {
  const reminderTime = new Date();
  reminderTime.setDate(reminderTime.getDate() + 2); // Example for a 2-day interval

  // Notify user (could be integrated with push notifications)
  console.log(`Reminder set for watering ${plant.name} on ${reminderTime}`);
}
...
app.post('/login', (req, res) => {
  ...
  // Check user credentials (This is a simplified example; in practice, you'd query your database)
